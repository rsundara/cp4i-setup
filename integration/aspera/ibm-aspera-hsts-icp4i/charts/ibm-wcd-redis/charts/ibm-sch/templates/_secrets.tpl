...
touch /tmp/secretGen/tls/openssl.cnf
cat << 'EOF' > /tmp/secretGen/tls/openssl.cnf
[req]
req_extensions = v3_req
distinguished_name = icp-proxy
[icp-proxy]
[v3_ca]
...
openssl req -x509 -new -nodes -key {{ $tlsOutPath }}.key -subj "/CN=cp4i" -config <(cat /tmp/secretGen/tls/openssl.cnf) -days 3650 -reqexts v3_req -extensions v3_ca -out {{ $tlsOutPath }}.crt
